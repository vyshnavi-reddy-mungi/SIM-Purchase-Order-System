...
public class ApiErrorCodes {
    ...
    public static final String CUSTOMER_NOT_ELIGIBLE = "1004";
    public static final String INSUFFICIENT_AMOUNT = "1005";
    public static final String SIM_CARD_NOT_FOUND = "1006";
